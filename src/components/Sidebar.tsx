...
export default function Sidebar({ visibleTabs }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-20 bg-gray-300 border-r border-gray-300">
        <div className="p-4">
      ...
      {mobileNavOpen && (
        <>
          ...
          {/* Navigation Panel */}
          <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-gray-300 border-t border-gray-300 z-50 rounded-t-2xl shadow-2xl animate-slide-up">
